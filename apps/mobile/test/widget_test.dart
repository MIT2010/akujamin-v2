...
void main() {
  ...
  testWidgets('boots straight into the login page for an unauthenticated, '
      'not-first-launch user', (tester) async {
  ...
  testWidgets('boots straight into the onboarding carousel for a genuine first '
